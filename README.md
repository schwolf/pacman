...
3rd-Party JS-Fehler aus systemtest (test funktioniert)
-------------------------------------------------

URL:
[systemtest]/de/sonstige/angebotswandlung.html?angebotsnr=FaLtEwnao6t6Xx3TyZ4KVC_-SH3cgiYJvkGIPXBnOciycj3A13RtjquIfQAeZ1gZQZ72DtxfIfZxlv8fjHBWChtrUTWXUYwww7VFaRmCCN1K1SFs1SJAY1rMoFGgpMJgmBNMtw-UCUUU5Fj9XjjcwTt_8AFO7i1ZCqcKHAUaF7g

IST:
JS-Fehler beim Aufruf in estag-server-code-4fd66ad2a78153e221.js?rnd=9296139290954516000:456:
Uncaught DOMException: Failed to read the 'cookie' property from 'Document': The document is sandboxed and lacks the 'allow-same-origin' flag.
    at getCookie (https://otqp.s3.eu-central-1.amazonaws.com/estag-server-code-4fd66ad2a78153e221.js?rnd=9296139290954516000:456:25)...
    
SOLL:
Keine Fehlermeldung beim Aufruf.

============================================================================================================================================================


Monitoring von clientseitigen Fehlern
-------------------------------------------------

Aktuell werden clientseitige Fehler in die Konsole geloggt.
Analog Team 1 sollen clientseitige Fehler an track.js gesendet werden um diese monitoren zu können.
Dazu ist Absprache mit Team 1 notwendig.


============================================================================================================================================================

Ausrichtung Feedback-Texte
-------------------------------------------------

IST: Feedback-Texte sind unterschiedlich ausgerichtet.
SOLL: Feedback-Texte sind einheitlich ausgerichtet.

============================================================================================================================================================

Feingranularere Unterscheidung technischer Fehler
-------------------------------------------------

Das Aufrufen eines Angebots mit nicht entschlüsselbarer Angebotsnummer soll zu einem technischen Fehler führen (aktuell fachlicher Fehler).

Die technische Fehlermeldung soll um einen Hinweis ergänzt werden, dass der Anwender den eingegebenen Link kontrollieren soll.
